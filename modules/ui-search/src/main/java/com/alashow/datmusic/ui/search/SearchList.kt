...
import com.alashow.datmusic.domain.models.errors.EmptyResultException
import com.alashow.datmusic.ui.albums.AlbumColumn
import com.alashow.datmusic.ui.albums.AlbumsDefaults
import com.alashow.datmusic.ui.artists.ArtistColumn
import com.alashow.datmusic.ui.artists.ArtistsDefaults
...
import com.alashow.ui.components.ProgressIndicatorSmall
import com.alashow.ui.items
...
internal fun SearchList(
    ...
    SwipeRefresh(
      ...
      //  Text(text = "hello", style = MaterialTheme.typography.h1, modifier = Modifier.background(Color.Red).height(100.dp))
