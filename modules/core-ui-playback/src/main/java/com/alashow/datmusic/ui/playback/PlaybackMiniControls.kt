...
import com.alashow.datmusic.playback.artworkUri
import com.alashow.datmusic.playback.isActive
import com.alashow.datmusic.playback.isBuffering
...
import com.alashow.datmusic.ui.playback.components.PlaybackPager
import com.alashow.datmusic.ui.playback.components.animatePlaybackProgress
import com.alashow.domain.models.VideoList
...
import com.alashow.ui.Dismissable
...
fun getVideoList(): List<Video> {
    ...
    return remember(context) {
        val content = context.resources.openRawResource(com.alashow.datmusic.ui.playback.R.raw.videos)
            .bufferedReader()
            .use { it.readText() }
